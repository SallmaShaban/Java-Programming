...
class Student{
    ...
    public static void main(String [] args){
        ...
        Student s1=new Student("Alex",21,1234567891,10);//creating a s1 object of Student
        Student s2=new Student("Bob",37,1987654321,11);//creating a s2 object of Student
